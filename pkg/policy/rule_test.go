...
func TestL4Policy(t *testing.T) {
	...
	res.Ingress.PortRules, err =
		rule1.resolveIngressPolicy(td.testPolicyContext, toBar, &ingressState, NewL4PolicyMap(nil), nil, nil)
	require.NoError(t, err)
	require.NotNil(t, res.Ingress)

	res.Egress.PortRules, err =
		rule1.resolveEgressPolicy(td.testPolicyContext, fromBar, &egressState, NewL4PolicyMap(nil), nil, nil)
	require.NoError(t, err)
	...
	res1, err := rule1.resolveIngressPolicy(td.testPolicyContext, toFoo, &ingressState, NewL4PolicyMap(nil), nil, nil)
	require.NoError(t, err)
	res2, err := rule1.resolveEgressPolicy(td.testPolicyContext, fromFoo, &ingressState, NewL4PolicyMap(nil), nil, nil)
	require.NoError(t, err)
	...
	res.Ingress.PortRules, err = rule2.resolveIngressPolicy(td.testPolicyContext, &ctx, &ingressState, NewL4PolicyMap(nil), nil, nil)
	require.NoError(t, err)
	require.NotNil(t, res.Ingress)

	t.Log(buffer)

	res.Egress.PortRules, err = rule2.resolveEgressPolicy(td.testPolicyContext, fromBar, &egressState, NewL4PolicyMap(nil), nil, nil)
	require.NoError(t, err)
	require.NotNil(t, res.Egress)
	...
	res1, err = rule2.resolveIngressPolicy(td.testPolicyContext, toFoo, &ingressState, NewL4PolicyMap(nil), nil, nil)
	require.NoError(t, err)
	require.Nil(t, res1)

	res2, err = rule2.resolveEgressPolicy(td.testPolicyContext, fromFoo, &egressState, NewL4PolicyMap(nil), nil, nil)
	require.NoError(t, err)
	require.Nil(t, res2)
...
func TestMergeL4PolicyIngress(t *testing.T) {
	...
	state := traceState{}
	res, err := rule1.resolveIngressPolicy(td.testPolicyContext, toBar, &state, NewL4PolicyMap(nil), nil, nil)
	require.NoError(t, err)
...
func TestMergeL4PolicyEgress(t *testing.T) {
	...
	state := traceState{}
	res, err := rule1.resolveEgressPolicy(td.testPolicyContext, fromBar, &state, NewL4PolicyMap(nil), nil, nil)
...
func TestMergeL7PolicyIngress(t *testing.T) {
	...
	state = traceState{}
	res, err = rule1.resolveIngressPolicy(td.testPolicyContext, toFoo, &state, NewL4PolicyMap(nil), nil, nil)
	require.NoError(t, err)
	require.Nil(t, res)
	...
	state = traceState{}
	res, err = rule2.resolveIngressPolicy(td.testPolicyContext, toBar, &state, NewL4PolicyMap(nil), nil, nil)
	require.NoError(t, err)
	require.NotNil(t, res)
	require.EqualValues(t, expected, res)
	require.Equal(t, 1, state.selectedRules)
	...
	state = traceState{}
	res, err = rule2.resolveIngressPolicy(td.testPolicyContext, toFoo, &state, NewL4PolicyMap(nil), nil, nil)
	require.NoError(t, err)
	require.Nil(t, res)
	require.Equal(t, 0, state.selectedRules)
	require.Equal(t, 0, state.matchedRules)
	...
	state = traceState{}
	res, err = rule3.resolveIngressPolicy(td.testPolicyContext, toBar, &state, NewL4PolicyMap(nil), nil, nil)
	require.NoError(t, err)
	require.NotNil(t, res)
	require.EqualValues(t, expected, res)
	require.Equal(t, 1, state.selectedRules)
...
func TestMergeL7PolicyEgress(t *testing.T) {
	...
	state = traceState{}
	res, err = rule1.resolveEgressPolicy(td.testPolicyContext, fromFoo, &state, NewL4PolicyMap(nil), nil, nil)
	require.NoError(t, err)
	require.Nil(t, res)
	require.Equal(t, 0, state.selectedRules)
	require.Equal(t, 0, state.matchedRules)
	...
	state = traceState{}
	res, err = rule2.resolveEgressPolicy(td.testPolicyContext, fromBar, &state, NewL4PolicyMap(nil), nil, nil)
	require.NoError(t, err)
	require.NotNil(t, res)
	require.EqualValues(t, expected, res)
	require.Equal(t, 1, state.selectedRules)
	...
	state = traceState{}
	res, err = rule2.resolveEgressPolicy(td.testPolicyContext, fromFoo, &state, NewL4PolicyMap(nil), nil, nil)
	require.NoError(t, err)
	require.Nil(t, res)
	require.Equal(t, 0, state.selectedRules)
	require.Equal(t, 0, state.matchedRules)
	...
	state = traceState{}
	res, err = rule3.resolveEgressPolicy(td.testPolicyContext, fromBar, &state, NewL4PolicyMap(nil), nil, nil)
	require.NoError(t, err)
	require.NotNil(t, res)
	require.EqualValues(t, expected, res)
	require.Equal(t, 1, state.selectedRules)
...
func TestICMPPolicy(t *testing.T) {
	...
	res = NewL4Policy(0)
	res.Ingress.PortRules, err =
		rule2.resolveIngressPolicy(td.testPolicyContext, toBar, &ingressState, NewL4PolicyMap(nil), nil, nil)
	require.NoError(t, err)
	require.NotNil(t, res.Ingress)
	...
	res = NewL4Policy(0)
	res.Ingress.PortRules, err =
		rule3.resolveIngressPolicy(td.testPolicyContext, toBar, &ingressState, NewL4PolicyMap(nil), nil, nil)
	require.NoError(t, err)
	require.NotNil(t, res.Ingress)
...
func TestL3RuleLabels(t *testing.T) {
	...
	for _, test := range testCases {
		...
		//require.EqualValues(t, NewL4PolicyMap(nil), finalPolicy.Ingress)
