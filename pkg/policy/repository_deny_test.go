...
func TestWildcardL3RulesIngressDeny(t *testing.T) {
	...
	expectedPolicy := NewL4PolicyMap(map[string]*L4Filter{
		"0/ANY": {
			Port:     0,
...
func TestWildcardL4RulesIngressDeny(t *testing.T) {
	...
	expectedDenyPolicy := NewL4PolicyMap(map[string]*L4Filter{
		"80/TCP": {
			Port:     80,
...
func TestL3DependentL4EgressDenyFromRequires(t *testing.T) {
	...
	if !assert.True(t, expectedDenyPolicy.Equals(t, policyDeny), policyDeny.Diff(t, expectedDenyPolicy)) {
